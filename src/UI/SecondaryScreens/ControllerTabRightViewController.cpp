...
//            auto texts = BeatSaberUI::CreateHorizontalLayoutGroup(scrollView->get_transform());
            ...
            allButtons.push_back(BeatSaberUI::CreateUIButton(cutRumbleButtons->get_transform(), "Left Cut Rumble Test", [this] () {
            ...
            allButtons.push_back(BeatSaberUI::CreateUIButton(cutRumbleButtons->get_transform(), "Right Cut Rumble Test", [this] () {
                weakPreset->dyn__duration() = std::min(0.2f, DURATION_NORMAL * getTMTConfig().cutRumbleStrength.GetValue());
                weakPreset->dyn__strength() = STRENGTH_NORMAL * std::min(1.0f, getTMTConfig().cutRumbleStrength.GetValue() * 1.2f);
            ...
            allButtons.push_back(BeatSaberUI::CreateUIButton(chainRumbleButtons->get_transform(), "Left Chain Rumble Test", [this] () {
                normalPreset->dyn__duration() = std::min(0.2f, DURATION_WEAK * getTMTConfig().chainRumbleStrength.GetValue());
                normalPreset->dyn__strength() = STRENGTH_WEAK * std::min(1.0f, getTMTConfig().chainRumbleStrength.GetValue() * 1.2f);

                testRumble(normalPreset, SaberType::_get_SaberA());
            }));

            allButtons.push_back(BeatSaberUI::CreateUIButton(chainRumbleButtons->get_transform(), "Right Chain Rumble Test", [this] () {
            ...
            allButtons.push_back(BeatSaberUI::CreateUIButton(arcRumbleButtons->get_transform(), "Left Arc Rumble Test", [this] () {
                normalPreset->dyn__duration() = std::min(0.2f, DURATION_WEAK * getTMTConfig().chainRumbleStrength.GetValue());
                normalPreset->dyn__strength() = STRENGTH_WEAK * std::min(1.0f, getTMTConfig().chainRumbleStrength.GetValue() * 1.2f);
            ...
            allButtons.push_back(BeatSaberUI::CreateUIButton(arcRumbleButtons->get_transform(), "Right Arc Rumble Test", [this] () {
                weakPreset->dyn__duration() = std::min(0.2f, DURATION_WEAK * getTMTConfig().chainRumbleStrength.GetValue());
                weakPreset->dyn__strength() = STRENGTH_WEAK * std::min(1.0f, getTMTConfig().chainRumbleStrength.GetValue() * 1.2f);
