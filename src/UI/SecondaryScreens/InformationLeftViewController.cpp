...
#define CreateExternalButton(transform, text, tooltip, url) \
    ...
    void InformationLeftViewController::DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) {
        ...
        if(firstActivation) {
            ...
            CreateExternalButton(scrollView->get_transform(), "Patreon", "Join my patreon to get access to upcoming mods and updates before they release.", "https://patreon.com/cal117")
            CreateExternalButton(scrollView->get_transform(), "Discord", "Join my discord and keep updated with whats going on with my mods.", "https://discord.gg/bhGPJGbegt")
            CreateExternalButton(scrollView->get_transform(), "More Mods", "Want to see what other mods I've made? Checkout my itch.io page here.", "https://cal117.itch.io/")
